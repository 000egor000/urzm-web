...
/**
 * Компонент Обоснование интервала настройки <CumulativeProduction />
 * @param {Object} props props компонента
 * @param {Object} props.container GoldenLayout container
 * @returns {JSX.Element}
 */
export const CumulativeProduction = ({ container }) => {
  ...
  const isNoDataSetting =
    (!isLoadingSetting && isLoadedSetting && isEmpty(dataSetting)) ||
  ...
  const chartsConfig = useCumulativeProductionConfig(data, dataSetting, height);
...
CumulativeProduction.propTypes = {
  container: pt.object,
};
