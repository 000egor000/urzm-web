...
/**
 * Компонент Обоснование интервала настройки <DailyProduction />
 * @param {Object} props props компонента
 * @param {Object} props.container GoldenLayout container
 * @returns {JSX.Element}
 */
export const DailyProduction = ({ container }) => {
  ...
  const chartsConfig = useDailyProductionConfig(data, dataSetting, height);
