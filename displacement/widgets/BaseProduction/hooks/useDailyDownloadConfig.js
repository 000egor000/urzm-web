...
const useDailyDownloadConfig = (data, dataSetting, height = 800) => {
  ...
  if (initData) {
    ...
    return {
      ...
      yAxis: [
        {
          title: {
            text: 'Суточная добыча нефти, т/сут.',
          },
          labels: {
            format: '{value}',
          },
        ...
        {
          title: { text: 'Суточная добыча жидкости, т/сут.' },
          labels: {
            format: '{value}',
          },
...
export default useDailyDownloadConfig;
